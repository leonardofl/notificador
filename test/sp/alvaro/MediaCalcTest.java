...
public class MediaCalcTest {
    ...
    public void setUp() throws Exception {
        ...
        TarjetaTurma bim1 = new TarjetaTurma("Matemática", "Areco", 22);
        ...
        TarjetaTurma bim2 = new TarjetaTurma("Matemática", "Areco", 22);
        ...
        TarjetaTurma bim3 = new TarjetaTurma("Matemática", "Areco", 22);
        ...
        TarjetaTurma bim4 = new TarjetaTurma("Matemática", "Areco", 22);
        ...
        expectedMedias = new TarjetaTurma("Matemática", "Areco", 88);
