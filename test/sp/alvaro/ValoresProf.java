...
public class ValoresProf {
    ...
    private void generateData1() {
        ...
        // 1o bim
        String trm = "6aA"; 
        TarjetaProf t16a = new TarjetaProf(trm, 22);
        ...
        trm = "6aB";
        TarjetaProf t16b = new TarjetaProf(trm, 23);
        ...
        trm = "6aC";
        TarjetaProf t16c = new TarjetaProf(trm, 22);
        ...
        trm = "6aD";
        TarjetaProf t16d = new TarjetaProf(trm, 23);
        ...
        // 2o bim
        trm = "6aA"; 
        TarjetaProf t26a = new TarjetaProf(trm, 22);
        ...
        trm = "6aB";
        TarjetaProf t26b = new TarjetaProf(trm, 23);
        ...
        trm = "6aC";
        TarjetaProf t26c = new TarjetaProf(trm, 22);
        ...
        trm = "6aD";
        TarjetaProf t26d = new TarjetaProf(trm, 23);
        ...
        // 3o bim
        trm = "6aA"; 
        TarjetaProf t36a = new TarjetaProf(trm, 22);
        ...
        trm = "6aB";
        TarjetaProf t36b = new TarjetaProf(trm, 23);
        ...
        trm = "6aC";
        TarjetaProf t36c = new TarjetaProf(trm, 22);
        ...
        trm = "6aD";
        TarjetaProf t36d = new TarjetaProf(trm, 23);
        ...
        // 4o bim
        trm = "6aA"; 
        TarjetaProf t46a = new TarjetaProf(trm, 22);
        ...
        trm = "6aB";
        TarjetaProf t46b = new TarjetaProf(trm, 23);
        ...
        trm = "6aC";
        TarjetaProf t46c = new TarjetaProf(trm, 22);
        ...
        trm = "6aD";
        TarjetaProf t46d = new TarjetaProf(trm, 23);
